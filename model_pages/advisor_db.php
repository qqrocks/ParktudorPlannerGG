...
{
    $db=Database::getDB();
    $query="SELECT DISTINCT advisors.advisorID, a_f_name, a_l_name FROM advisors INNER JOIN students ON students.advisorID = advisors.advisorID WHERE students.gradeID=$grade_id";
